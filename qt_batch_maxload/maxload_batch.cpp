...
MyDlg::MyDlg()
{
    ...
    QObject::connect(ui.comboBox_start_together_tab1, SIGNAL(currentIndexChanged(int)), this, SLOT(start_together_tab1(int)));
    QObject::connect(ui.lineEdit_blocksize_tab1, SIGNAL(textChanged(QString)), this, SLOT(blocksize_tab1(QString)));
    QObject::connect(ui.lineEdit_filenum_tab1, SIGNAL(textChanged(QString)), this, SLOT(filenum_tab1(QString)));
    QObject::connect(ui.lineEdit_clientnum_tab1, SIGNAL(textChanged(QString)), this, SLOT(clientnum_tab1(QString)));
    ...
    QObject::connect(ui.comboBox_start_together_tab2, SIGNAL(currentIndexChanged(int)), this, SLOT(start_together_tab1(int)));
    QObject::connect(ui.lineEdit_blocksize_tab2, SIGNAL(textChanged(QString)), this, SLOT(blocksize_tab1(QString)));
    QObject::connect(ui.lineEdit_filenum_tab2, SIGNAL(textChanged(QString)), this, SLOT(filenum_tab1(QString)));
    QObject::connect(ui.lineEdit_clientnum_tab2, SIGNAL(textChanged(QString)), this, SLOT(clientnum_tab1(QString)));
    ...
    QObject::connect(ui.comboBox_start_together_tab3, SIGNAL(currentIndexChanged(int)), this, SLOT(start_together_tab1(int)));
    QObject::connect(ui.lineEdit_blocksize_tab3, SIGNAL(textChanged(QString)), this, SLOT(blocksize_tab1(QString)));
    QObject::connect(ui.lineEdit_filenum_tab3, SIGNAL(textChanged(QString)), this, SLOT(filenum_tab1(QString)));
    QObject::connect(ui.lineEdit_clientnum_tab3, SIGNAL(textChanged(QString)), this, SLOT(clientnum_tab1(QString)));
...
void MyDlg::start_together_tab1(int index){
    int startip, endip;
    QString name = sender()->objectName();
    if(name[name.length() - 1] == '1'){
        startip = 11;
    ...
    for(int i = startip; i<= endip; ++i){
        QComboBox *comboBox_p2p_ = ui.tabWidget->findChild<QComboBox *>("comboBox_start_together_" + QString::number(i));
        if(!comboBox_p2p_){
            continue;
        }
...
void MyDlg::filenum_tab1(QString value){
    int startip, endip;
    QString name = sender()->objectName();
    if(name[name.length() - 1] == '1'){
        startip = 11;
    ...
    for(int i = startip; i<= endip; ++i){
        QLineEdit *lineEdit_sbuffer_ = ui.tabWidget->findChild<QLineEdit *>("lineEdit_filenum_" + QString::number(i));
...
void MyDlg::clientnum_tab1(QString value){
    int startip, endip;
    QString name = sender()->objectName();
    if(name[name.length() - 1] == '1'){
        startip = 11;
    ...
    for(int i = startip; i<= endip; ++i){
        QLineEdit *lineEdit_speriod_ = ui.tabWidget->findChild<QLineEdit *>("lineEdit_clientnum_" + QString::number(i));
...
void MyDlg::sbuffer_tab1(QString value){
    ...
    for(int i = startip; i<= endip; ++i){
        QLineEdit *lineEdit_cperiod_ = ui.tabWidget->findChild<QLineEdit *>("lineEdit_sbuffer_" + QString::number(i));
