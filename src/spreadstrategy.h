...
public:
	...
	virtual int GetDeleteFile(vector<FileNode> &filelist, vector<int> &output) { return 0; }
};
...
public:
	...
	virtual int GetDeleteFile(vector<FileNode> &filelist, vector<int> &output);
};
...
class FIFOSpreadStrategy : public SpreadStrategy{
public:
	virtual void ReadFile(FileNode &file, double vtime);
	virtual int GetSpreadFile(vector<FileNode> &filelist, vector<int> &output);
	virtual int GetDeleteFile(vector<FileNode> &filelist, vector<int> &output);
